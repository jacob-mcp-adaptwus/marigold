      ...
      <div className="bg-white/95 py-12 relative z-10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto prose prose-lg">
            ...
            <div className="mt-12 mb-8 p-8 bg-gradient-to-br from-[#fdf8f1] via-white to-[#f8f8f8] rounded-xl border border-[#f59d40] shadow-lg">
              <div className="flex items-center mb-4">
                <Lightbulb className="h-8 w-8 text-[#f59d40] mr-3" />
                <h3 className="text-2xl font-bold text-[#2a2b2a] m-0">{storyData.cta.title}</h3>
              </div>
              <p className="mb-6 text-lg">
                {storyData.cta.content}
              </p>
              <Link 
                to={storyData.cta.buttonLink} 
                className="inline-flex items-center px-6 py-3 bg-[#bb141a] hover:bg-[#a01217] text-white font-semibold rounded-lg transition-colors"
              >
                {storyData.cta.buttonText}
